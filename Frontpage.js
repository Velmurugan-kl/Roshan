...
navigate("/carnatic")
  ...
  return (
    <div className='contfro'>
    
      <center>
        <h1 className='wel'>Welcome to Popz tune</h1>
        </center>
      <div className="About">
       <p className='car'> Welcome to our music learning app, where the world of melody, harmony, and rhythm awaits you! Whether you're a budding musician, an aspiring composer, or simply a music enthusiast looking to expand your knowledge, you've come to the right place.
...
<button class="button button2" onClick={handleClick}>Begin learning!!!</button>
        ...
        <div class="courses">
          <center>
          <h1 className='wel'>Popular courses videos</h1>
